...
class Roleplay(commands.Cog):
    ...
    async def kiss(self, ctx, user: discord.Member = None):
        ...
        if response.status_code == 200:
            ...
            embed.set_author(name=f"{ctx.author.name} | kisses {user.name}", icon_url=user_pfp)
    ...
    async def hug(self, ctx, user: discord.Member = None):
        ...
        if response.status_code == 200:
            ...
            user_pfp = ctx.author.avatar.url if ctx.author.avatar else ctx.author.default_avatar.url
            embed.set_image(url=kiss)
            embed.set_author(name=f"{ctx.author.name} | hugs {user.name}", icon_url=user_pfp)
            await ctx.send(embed=embed)
    ...
    async def slap(self, ctx, user: discord.Member = None):
        ...
        if response.status_code == 200:
            ...
            user_pfp = ctx.author.avatar.url if ctx.author.avatar else ctx.author.default_avatar.url
            embed.set_image(url=kiss)
            embed.set_author(name=f"{ctx.author.name} | slaps {user.name}", icon_url=user_pfp)
            await ctx.send(embed=embed)
    ...
    async def cuddle(self, ctx, user: discord.Member = None):
        ...
        if response.status_code == 200:
            ...
            user_pfp = ctx.author.avatar.url if ctx.author.avatar else ctx.author.default_avatar.url
            embed.set_image(url=kiss)
            embed.set_author(name=f"{ctx.author.name} | cuddles {user.name}", icon_url=user_pfp)
            await ctx.send(embed=embed)
    ...
    async def tickle(self, ctx, user: discord.Member = None):
        ...
        if response.status_code == 200:
            ...
            user_pfp = ctx.author.avatar.url if ctx.author.avatar else ctx.author.default_avatar.url
            embed.set_image(url=kiss)
            embed.set_author(name=f"{ctx.author.name} | tickles {user.name}", icon_url=user_pfp)
            await ctx.send(embed=embed)
    ...
    async def lick(self, ctx, user: discord.Member = None):
        ...
        if response.status_code == 200:
            ...
            user_pfp = ctx.author.avatar.url if ctx.author.avatar else ctx.author.default_avatar.url
            embed.set_image(url=kiss)
            embed.set_author(name=f"{ctx.author.name} | licks {user.name}", icon_url=user_pfp)
            await ctx.send(embed=embed)
    ...
    async def pat(self, ctx, user: discord.Member = None):
        ...
        if response.status_code == 200:
            ...
            user_pfp = ctx.author.avatar.url if ctx.author.avatar else ctx.author.default_avatar.url
            embed.set_image(url=kiss)
            embed.set_author(name=f"{ctx.author.name} | pats {user.name}", icon_url=user_pfp)
            await ctx.send(embed=embed)
    ...
    async def stare(self, ctx, user: discord.Member = None):
        ...
        if response.status_code == 200:
            ...
            user_pfp = ctx.author.avatar.url if ctx.author.avatar else ctx.author.default_avatar.url
            embed.set_image(url=kiss)
            embed.set_author(name=f"{ctx.author.name} | stares at {user.name}", icon_url=user_pfp)
            await ctx.send(embed=embed)
    ...
    async def pinch(self, ctx, user: discord.Member = None):
        ...
        if response.status_code == 200:
            ...
            user_pfp = ctx.author.avatar.url if ctx.author.avatar else ctx.author.default_avatar.url
            embed.set_image(url=kiss)
            embed.set_author(name=f"{ctx.author.name} | pinches {user.name}", icon_url=user_pfp)
            await ctx.send(embed=embed)
