...
class Paginator(View):
    def __init__(self, ctx, pages: list[Embed], current: int = 0, timeout: Optional[float] = None):
        self.ctx = ctx
        self.pages = pages
        ...
        self.add_item(PaginatorButton(style=ButtonStyle.primary, custom_id='previous', emoji=Emojis.Paginator.left))
        self.add_item(PaginatorButton(style=ButtonStyle.primary, custom_id='next', emoji=Emojis.Paginator.right))
        self.add_item(PaginatorButton(style=ButtonStyle.grey, custom_id='pages', emoji=Emojis.Paginator.navigate))
        self.add_item(PaginatorButton(style=ButtonStyle.grey, custom_id='cancel', emoji=Emojis.Paginator.cancel))
...
class PaginatorButton(discord.ui.Button):
    ...
    def __init__(self, style: discord.ButtonStyle, emoji: str, custom_id: Optional[str] = None):
...
class PagesModal(discord.ui.Modal, title='Select Page'):
    ...
    async def on_submit(self, interaction: discord.Interaction):
        try: 
            ...
            return await interaction.response.send_message('Please provide a valid page number.', ephemeral=True)
